...
var ButtonWrapper = styled.span(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  border: 1px solid transparent;\n  margin: 0 2px;\n  font-size: 0;\n  display: flex;\n  align-items: center;\n  padding: 1px;\n  border-radius: 6px;\n  &:hover {\n    border: 1px solid ", ";\n  }\n"], ["\n  border: 1px solid transparent;\n  margin: 0 2px;\n  font-size: 0;\n  display: flex;\n  align-items: center;\n  padding: 1px;\n  border-radius: 6px;\n  &:hover {\n    border: 1px solid ", ";\n  }\n"])), colors.N50);
var Color = /** @class */ (function (_super) {
    ...
    Color.prototype.render = function () {
        ...
        return (React.createElement(ButtonWrapper, null,
            React.createElement(FormattedMessage, __assign({}, messages[value + "Color"]), function (label) { return (React.createElement(Button, { onClick: _this.onClick, onMouseEnter: _this.onMouseEnter, onMouseLeave: _this.onMouseLeave, onMouseDown: _this.onMouseDown, tabIndex: tabIndex, className: "" + (isSelected ? 'selected' : ''), title: label, style: {
