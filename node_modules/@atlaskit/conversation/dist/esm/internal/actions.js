...
export var updateComment = function (conversationId, commentId, value, provider, onSuccess) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
export var deleteComment = function (conversationId, commentId, provider, onSuccess) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
export var revertComment = function (conversationId, commentId, provider) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        provider.revertComment(conversationId, commentId);
        return [2 /*return*/];
    });
}); }; };
export var updateUser = function (user, provider) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        provider.updateUser(user);
        return [2 /*return*/];
    });
}); }; };
export var createConversation = function (localId, value, meta, provider, objectId, containerId, onSuccess) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    var conversationId;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
export var saveDraft = function (isLocal, value, conversationId, commentId, meta, provider, objectId, containerId) { return function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
