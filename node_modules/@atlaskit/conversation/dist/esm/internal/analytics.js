...
export function fireEvent(analyticsEvent, eventData) {
    analyticsEvent.update(__assign(__assign({}, eventData), { eventType: eventData.eventType || eventTypes.UI, attributes: __assign(__assign({}, analyticsEvent), eventData.attributes) }));
