...
var mapStateToProps = function (state, ownProps) {
    ...
    return __assign(__assign({}, ownProps), { conversation: conversation,
        comments: comments,
        objectId: objectId,
...
var ConversationContainer = /** @class */ (function (_super) {
    __extends(ConversationContainer, _super);
    ...
    ConversationContainer.prototype.render = function () {
        ...
        return (React.createElement(Provider, { store: store },
            React.createElement(ResourcedConversation, __assign({}, props, { localId: localId }))));
    };
