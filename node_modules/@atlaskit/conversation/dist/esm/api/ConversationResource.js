...
var AbstractConversationResource = /** @class */ (function () {
     ...
     */
    AbstractConversationResource.prototype.getConversations = function (_objectId, _containerId) {
     ...
     */
    AbstractConversationResource.prototype.create = function (_localId, _value, _meta, _objectId, _containerId) {
        return Promise.reject('Not implemented');
    };
    /**
     * Adds a comment to a parent, or update if existing. ParentId can be either a conversation or another comment.
     */
    AbstractConversationResource.prototype.addComment = function (_conversationId, _parentId, _doc, _localId) {
     ...
     */
    AbstractConversationResource.prototype.updateComment = function (_conversationId, _commentId, _document) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('Not implemented')];
            });
     ...
     */
    AbstractConversationResource.prototype.deleteComment = function (_conversationId, _commentId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('Not implemented')];
            });
     ...
     */
    AbstractConversationResource.prototype.revertComment = function (_conversationId, _commentId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('Not implemented')];
            });
     ...
     */
    AbstractConversationResource.prototype.updateUser = function (_user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('Not implemented')];
            });
    ...
    AbstractConversationResource.prototype.saveDraft = function (_isLocal, _value, _conversationId, _commentId, _meta, _objectId, _containerId) {
        // Nothing to see here..
    };
...
var ConversationResource = /** @class */ (function (_super) {
    __extends(ConversationResource, _super);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.config.url;
                        fetchOptions = __assign({ credentials: 'include', headers: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (tempConversation) {
                            dispatch({
                                ...
                                payload: __assign({}, tempConversation),
                            });
                        }
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        error_1 = _a.sent();
                        result = __assign(__assign({}, tempConversation), { error: error_1 });
                        dispatch({ type: CREATE_CONVERSATION_ERROR, payload: result });
                        return [2 /*return*/, result];
                    case 4:
                        dispatch({
                            type: CREATE_CONVERSATION_SUCCESS,
                            payload: __assign(__assign({}, result), { localId: localId }),
                        });
                        return [2 /*return*/, __assign(__assign({}, result), { localId: localId })];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        dispatch({
                            ...
                            payload: __assign(__assign({}, result), { localId: tempComment.localId }),
                        });
                        return [2 /*return*/, __assign(__assign({}, result), { localId: tempComment.localId })];
                }
            });
        });
    };
                    ...
                    case 0:
                        ...
                        if (tempComment) {
                            dispatch({
                                ...
                                payload: __assign(__assign({}, tempComment), { document: {
                                        adf: document,
                                    } }),
                            });
                        }
    ...
    ConversationResource.prototype.getComment = function (conversationId, commentId) {
        ...
        var _a = __read(state.conversations.filter(function (c) { return c.conversationId === conversationId; }), 1), conversation = _a[0];
        if (!conversation) {
            return undefined;
        }
        var _b = __read((conversation.comments || []).filter(function (c) { return c.commentId === commentId; }), 1), comment = _b[0];
