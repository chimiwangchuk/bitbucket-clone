...
var ContainerResult = /** @class */ (function (_super) {
    __extends(ContainerResult, _super);
    ...
    ContainerResult.prototype.render = function () {
        var _a = this.props, name = _a.name, isPrivate = _a.isPrivate, _b = _a.type, type = _b === void 0 ? 'container' : _b, subText = _a.subText, commonResultProps = __rest(_a, ["name", "isPrivate", "type", "subText"]);
        return (React.createElement(ResultBase, __assign({}, commonResultProps, { type: type, text: name, subText: subText, icon: this.getAvatar() })));
    };
