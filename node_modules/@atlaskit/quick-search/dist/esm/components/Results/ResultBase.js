...
var ResultBase = /** @class */ (function (_super) {
    ...
    function ResultBase() {
        ...
        _this.handleClick = function (e) {
            ...
            if (context.sendAnalytics) {
                context.sendAnalytics(QS_ANALYTICS_EV_SUBMIT, __assign(__assign({}, _this.getAnalyticsData()), { method: 'click', newTab: e && (e.metaKey || e.shiftKey || e.ctrlKey) }));
            }
            if (onClick) {
    ...
    ResultBase.prototype.getAnalyticsData = function () {
        ...
        return __assign({ index: context.getIndex(resultId), type: type,
...
export { ResultBase };
export default (function (props) { return (React.createElement(ResultContext.Consumer, null, function (context) { return React.createElement(ResultBase, __assign({ context: context }, props)); })); });
