    ...
    function SiteEmojiResource(siteServiceConfig, mediaApiToken) {
        ...
        this.postToEmojiService = function (upload, fileId) {
            ...
            return serviceUtils
                ...
                if (emojis.length) {
                    var _a = emojis[0], altRepresentations = _a.altRepresentations, emoji = __rest(_a, ["altRepresentations"]);
                    var response_1 = __assign(__assign({}, emoji), { representation: convertImageToMediaRepresentation(emoji.representation) });
