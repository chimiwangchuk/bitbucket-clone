...
export var CachingEmoji = function (props) {
    ...
    var placeholderSize = props.placeholderSize, emojiProps = __rest(props, ["placeholderSize"]);
    if (isMediaEmoji(props.emoji)) {
        return React.createElement(CachingMediaEmoji, __assign({}, props));
    }
    return React.createElement(Emoji, __assign({}, emojiProps));
};
/**
...
var CachingMediaEmoji = /** @class */ (function (_super) {
    __extends(CachingMediaEmoji, _super);
    ...
    CachingMediaEmoji.prototype.render = function () {
        ...
        var _a = this.props, children = _a.children, placeholderSize = _a.placeholderSize, otherProps = __rest(_a, ["children", "placeholderSize"]);
        var emojiComponent;
        if (cachedEmoji) {
            emojiComponent = (React.createElement(Emoji, __assign({}, otherProps, { emoji: cachedEmoji, onLoadError: this.handleLoadError })));
        }
        else {
