...
export var addOne = function (reaction) { return (__assign(__assign({}, reaction), { count: reaction.count + 1, reacted: true })); };
export var removeOne = function (reaction) { return (__assign(__assign({}, reaction), { count: reaction.count - 1, reacted: false })); };
