...
export var createAndFireSafe = function (createAnalyticsEvent, creator) {
    ...
    if (createAnalyticsEvent) {
        createAndFireEventInElementsChannel(creator.apply(void 0, __spread(args)))(createAnalyticsEvent);
    }
};
var createPayload = function (action, actionSubject, eventType, actionSubjectId) { return function (attributes) { return ({
    ...
    attributes: __assign(__assign({}, attributes), { packageName: packageName,
...
export var createRestSucceededEvent = function (actionSubject) {
    return createPayload('succeeded', actionSubject, OPERATIONAL_EVENT_TYPE)({});
};
export var createRestFailedEvent = function (actionSubject, errorCode) {
