...
var ReactionsWithoutAnalytics = /** @class */ (function (_super) {
    __extends(ReactionsWithoutAnalytics, _super);
        ...
        _this.getTooltip = function () {
            ...
            switch (status) {
                case ReactionStatus.error:
                    return errorMessage ? (errorMessage) : (React.createElement(FormattedMessage, __assign({}, messages.unexpectedError)));
                case ReactionStatus.loading:
                case ReactionStatus.notLoaded:
                    return React.createElement(FormattedMessage, __assign({}, messages.loadingReactions));
                default:
                    return undefined;
            }
        };
