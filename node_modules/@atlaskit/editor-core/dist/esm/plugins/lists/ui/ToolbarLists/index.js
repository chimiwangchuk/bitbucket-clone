...
import { toggleBulletList as toggleBulletListKeymap, toggleOrderedList as toggleOrderedListKeymap, tooltip, renderTooltipContent, } from '../../../../keymaps';
    ...
    ToolbarLists.prototype.render = function () {
        ...
        if (!isSmall) {
            ...
            return (React.createElement(ButtonGroup, { width: isReducedSpacing ? 'small' : 'large' },
                React.createElement(ToolbarButton, { spacing: isReducedSpacing ? 'none' : 'default', onClick: this.handleBulletListClick, selected: bulletListActive, disabled: bulletListDisabled || disabled, title: renderTooltipContent(labelUnorderedList, toggleBulletListKeymap), iconBefore: React.createElement(BulletListIcon, { label: labelUnorderedList }) }),
                React.createElement(ToolbarButton, { spacing: isReducedSpacing ? 'none' : 'default', onClick: this.handleOrderedListClick, selected: orderedListActive, disabled: orderedListDisabled || disabled, title: renderTooltipContent(labelOrderedList, toggleOrderedListKeymap), iconBefore: React.createElement(NumberListIcon, { label: labelOrderedList }) }),
