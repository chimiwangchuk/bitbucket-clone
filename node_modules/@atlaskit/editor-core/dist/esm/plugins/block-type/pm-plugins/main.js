...
export var createPlugin = function (dispatch, lastNodeMustBeParagraph) {
    ...
    return new Plugin({
        ...
        state: {
            ...
            apply: function (_tr, oldPluginState, _oldState, newState) {
                var newPluginState = __assign(__assign({}, oldPluginState), { currentBlockType: detectBlockType(oldPluginState.availableBlockTypes, newState), blockTypesDisabled: areBlockTypesDisabled(newState) });
