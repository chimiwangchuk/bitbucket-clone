...
var ToolbarBlockType = /** @class */ (function (_super) {
    __extends(ToolbarBlockType, _super);
        ...
        _this.createItems = function () {
            ...
            var items = availableBlockTypes.reduce(function (acc, blockType, blockTypeNo) {
                ...
                acc.push({
                    ...
                    elemAfter: (React.createElement(KeyboardShortcut, { selected: isActive }, tooltip(findKeymapByDescription(blockType.title.defaultMessage)))),
                    isActive: isActive,
                });
                return acc;
            }, []);
    ...
    ToolbarBlockType.prototype.render = function () {
        ...
        var longestDropdownMenuItem = __spread([
            NORMAL_TEXT
        ...
        var toolbarButtonFactory = function (disabled) {
            ...
            return (React.createElement(ToolbarButton, { spacing: isReducedSpacing ? 'none' : 'default', selected: active, className: "block-type-btn", disabled: disabled, onClick: _this.handleTriggerClick, title: labelTextStyles, "aria-label": "Font style", iconAfter: React.createElement(Wrapper, { isSmall: isSmall },
                ...
                React.createElement(FormattedMessage, __assign({}, (blockTypeTitles[0] || NORMAL_TEXT.title))),
