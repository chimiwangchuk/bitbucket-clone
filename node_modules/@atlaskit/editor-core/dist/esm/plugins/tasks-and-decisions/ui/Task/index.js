...
var TaskItem = /** @class */ (function (_super) {
    ...
    function TaskItem(props) {
        ...
        _this.renderWithProvider = function (providers) {
            var _a = _this.props, _providerFactory = _a.providers, formatMessage = _a.intl.formatMessage, otherProps = __rest(_a, ["providers", "intl"]);
            ...
            return (React.createElement(TaskItemWithProviders, __assign({}, otherProps, { placeholder: placeholder, taskDecisionProvider: taskDecisionProvider, contextIdentifierProvider: contextIdentifierProvider })));
        };
