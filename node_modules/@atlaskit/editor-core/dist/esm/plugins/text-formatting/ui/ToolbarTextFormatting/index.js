...
import { toggleBold, toggleItalic, renderTooltipContent, } from '../../../../keymaps';
...
var ToolbarTextFormatting = /** @class */ (function (_super) {
    __extends(ToolbarTextFormatting, _super);
    function ToolbarTextFormatting() {
        ...
        _this.handleBoldClick = withAnalytics('atlassian.editor.format.strong.button', function () {
            ...
            if (!strongDisabled) {
                ...
                return toggleStrongWithAnalytics({ inputMethod: INPUT_METHOD.TOOLBAR })(state, dispatch);
            }
            return false;
        });
        _this.handleItalicClick = withAnalytics('atlassian.editor.format.em.button', function () {
            ...
            if (!emDisabled) {
                var _a = _this.props.editorView, state = _a.state, dispatch = _a.dispatch;
                return toggleEmWithAnalytics({ inputMethod: INPUT_METHOD.TOOLBAR })(state, dispatch);
            }
            return false;
        });
        return _this;
    ...
    ToolbarTextFormatting.prototype.render = function () {
        ...
        return (React.createElement(ButtonGroup, { width: isReducedSpacing ? 'small' : 'large' },
            strongHidden ? null : (React.createElement(ToolbarButton, { spacing: isReducedSpacing ? 'none' : 'default', onClick: this.handleBoldClick, selected: strongActive, disabled: disabled || strongDisabled, title: renderTooltipContent(labelBold, toggleBold), iconBefore: React.createElement(BoldIcon, { label: labelBold }) })),
            emHidden ? null : (React.createElement(ToolbarButton, { spacing: isReducedSpacing ? 'none' : 'default', onClick: this.handleItalicClick, selected: emActive, disabled: disabled || emDisabled, title: renderTooltipContent(labelItalic, toggleItalic), iconBefore: React.createElement(ItalicIcon, { label: labelItalic }) }))));
    };
