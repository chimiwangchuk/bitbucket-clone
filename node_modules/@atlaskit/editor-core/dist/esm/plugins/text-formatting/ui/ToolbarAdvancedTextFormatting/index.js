...
var ToolbarAdvancedTextFormatting = /** @class */ (function (_super) {
    __extends(ToolbarAdvancedTextFormatting, _super);
    function ToolbarAdvancedTextFormatting() {
        ...
        _this.addRecordToItems = function (items, content, value, tooltip, isDisabled) {
            ...
            items.push({
                key: value,
                content: content,
                elemAfter: tooltip ? React.createElement(Shortcut, null, tooltip) : undefined,
                value: {
                    name: value,
                },
                isActive: active,
        ...
        _this.onItemActivated = function (_a) {
            var item = _a.item;
            analyticsService.trackEvent("atlassian.editor.format." + item.value.name + ".button");
            ...
            switch (item.value.name) {
                case 'underline':
                    ...
                    break;
                case 'code':
                    commands.toggleCodeWithAnalytics({ inputMethod: INPUT_METHOD.TOOLBAR })(state, dispatch);
                    break;
                case 'strike':
