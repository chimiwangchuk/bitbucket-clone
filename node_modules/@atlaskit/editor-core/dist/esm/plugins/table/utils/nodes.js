...
export var isLayoutSupported = function (state) {
    ...
    var _a = state.schema.nodes, bodiedExtension = _a.bodiedExtension, layoutSection = _a.layoutSection, expand = _a.expand;
    return (!hasParentNodeOfType([expand, layoutSection, bodiedExtension])(state.selection) &&
        permittedLayouts &&
...
export var tablesHaveDifferentNoOfColumns = function (currentTable, previousTable) {
...
function getTableWidths(node) {
    ...
    node.content.firstChild.content.forEach(function (cell) {
        if (Array.isArray(cell.attrs.colwidth)) {
            ...
            tableWidths.push.apply(tableWidths, __spread(cell.attrs.colwidth.slice(0, colspan)));
        }
    });
    return tableWidths;
}
