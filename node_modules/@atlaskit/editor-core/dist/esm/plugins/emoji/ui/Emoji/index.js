...
var EmojiNode = /** @class */ (function (_super) {
    ...
    function EmojiNode(props) {
        ...
        _this.renderWithProvider = function (providers) {
            ...
            return (React.createElement(ClickSelectWrapper, null,
                React.createElement(ResourcedEmoji, { emojiId: { id: id, fallback: fallback, shortName: shortName }, emojiProvider: providers.emojiProvider, showTooltip: true, fitToHeight: fitToHeight })));
        };
