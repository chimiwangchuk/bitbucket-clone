...
export var replaceDocument = function (doc, state, version, options, providerFactory, sanitizePrivateContent) {
    ...
    if (options && options.allowUnsupportedContent) {
        ...
        content = processRawValue(state.schema, doc, providerFactory, sanitizePrivateContent);
        hasContent = !!content;
    }
    else {
