...
export var handleInit = function (initData, view, options, providerFactory) {
    var doc = initData.doc, json = initData.json, version = initData.version;
    if (doc) {
        var state = view.state;
        var tr = replaceDocument(doc, state, version, options, providerFactory, options && options.sanitizePrivateContent);
...
export var applyRemoteSteps = function (json, userIds, view, options) {
    ...
    if (tr) {
        ...
        var _b = __read(json, 1), firstStep = _b[0];
        /**
