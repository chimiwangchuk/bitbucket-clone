...
export { isMarkAllowedInRange, isMarkExcluded, removeBlockMarks, sanitiseSelectionMarksForWrapping, } from './mark';
...
function getSelectedWrapperNodes(state) {
    ...
    if (state.selection) {
        ...
        var _b = state.schema.nodes, blockquote_1 = _b.blockquote, panel_1 = _b.panel, orderedList_1 = _b.orderedList, bulletList_1 = _b.bulletList, listItem_1 = _b.listItem, codeBlock_1 = _b.codeBlock, decisionItem_1 = _b.decisionItem, decisionList_1 = _b.decisionList, taskItem_1 = _b.taskItem, taskList_1 = _b.taskList;
        state.doc.nodesBetween($from.pos, $to.pos, function (node) {
            if (node.isBlock &&
                [
                    blockquote_1,
...
export function shallowEqual(obj1, obj2) {
    ...
    return (keys1.length === keys2.length &&
        keys1.reduce(function (acc, key) { return acc && obj1[key] === obj2[key]; }, true));
}
export function sum(arr, f) {
    return arr.reduce(function (val, x) { return val + f(x); }, 0);
}
