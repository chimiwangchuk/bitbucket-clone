...
var NameWrapper = styled.span(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  overflow: hidden;\n"], ["\n  overflow: hidden;\n"])));
export var Name = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n"], ["\n  color: ", ";\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n"])), colors.N800);
export var ContainerName = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 12px;\n"], ["\n  color: ", ";\n  font-size: 12px;\n"])), colors.N100);
var Icon = styled.span(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  min-width: 16px;\n  margin-top: 3px;\n  margin-right: 8px;\n"], ["\n  min-width: 16px;\n  margin-top: 3px;\n  margin-right: 8px;\n"])));
var RecentItem = /** @class */ (function (_super) {
    __extends(RecentItem, _super);
    function RecentItem() {
