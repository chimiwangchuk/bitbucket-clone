...
var ItemContentWrapper = styled.span(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  ", ";\n"], ["\n  ", ";\n"])), function (props) { return (props.hasElemBefore ? 'margin-left: 8px;' : ''); });
/**
...
var DropdownMenuWrapper = /** @class */ (function (_super) {
    __extends(DropdownMenuWrapper, _super);
    ...
    DropdownMenuWrapper.prototype.renderItem = function (item) {
        ...
        if (item.tooltipDescription) {
            return (React.createElement(Tooltip, { key: item.key || item.content, content: item.tooltipDescription, position: item.tooltipPosition }, dropListItem));
        }
        return dropListItem;
    };
