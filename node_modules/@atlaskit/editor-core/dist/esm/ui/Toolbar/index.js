...
var ToolbarComponentsWrapper = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
...
export function Toolbar(props) {
    ...
    return (React.createElement(ToolbarInner, __assign({}, props, { toolbarSize: toolbarSize, isToolbarReducedSpacing: toolbarSize < ToolbarSize.XXL })));
}
export default function ToolbarWithSizeDetector(props) {
    return (React.createElement("div", { style: { width: '100%', minWidth: '254px' } },
        React.createElement(WidthDetector, null, function (width) {
            return width === undefined ? null : React.createElement(Toolbar, __assign({}, props, { width: width }));
        })));
}
