...
var CollectionFetcher = /** @class */ (function () {
    ...
    CollectionFetcher.prototype.createFileStateObserver = function (id, details) {
        ...
        var mediaFile = __assign({ id: id }, details);
    ...
    CollectionFetcher.prototype.getItems = function (collectionName, params) {
        ...
        this.mediaStore
            .getCollectionItems(collectionName, __assign(__assign({}, params), { details: 'full' }))
            .then(function (items) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.mediaStore.getCollectionItems(collectionName, __assign(__assign({}, params), { inclusiveStartKey: inclusiveStartKey, details: 'full' }))];
                    case 1:
                        response = _c.sent();
                        ...
                        items = __spread(currentItems, newItems);
                        subject.next(items);
